...
const ProcessCard: React.FC<ProcessCardProps> = ({
  ...
  return (
    <div className="w-[297px] h-[297px] px-[15px] py-[13px] bg-[#F6F7F8] shadow-[0px_4px_4px_rgba(0,0,0,0.05)] overflow-hidden rounded-[20px] outline outline-[rgba(255,255,255,0.60)] outline-offset-[-1px] flex flex-col justify-start items-start gap-[10px]">
