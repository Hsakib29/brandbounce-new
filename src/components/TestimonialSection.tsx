...
const TestimonialsSection = () => {
  ...
  return (
    <>
      ...
      <div className="w-full min-h-[600px] sm:min-h-[800px] lg:min-h-[1000px] relative bg-gray-50 font-['Inter'] px-4 sm:px-8 md:px-12 lg:px-20 py-8 overflow-hidden">
        ...
        <div className="relative z-10 w-full max-w-sm sm:max-w-md md:max-w-lg lg:absolute lg:top-[436px] lg:left-[78px] inline-flex flex-col justify-start items-start gap-2.5 mx-auto lg:mx-0 mb-8 lg:mb-0">
        ...
        */}
        <div
          ...
          className="w-full h-[500px] sm:h-[700px] lg:w-[1082px] lg:h-[901.67px] relative lg:absolute lg:left-[776px] lg:top-[49px] overflow-hidden"
        >
          ...
          {/* Row 2 (Reverse Scroll, responsive positioning) */}
          <InfiniteScrollRow
            reverse={true}
            pauseOnHover={true}
